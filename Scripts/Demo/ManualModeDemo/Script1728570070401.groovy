...
WebUI.setEncryptedText(findTestObject('Page_Test Login  Practice Test Automation/input_Password_password'), 'p4y+y39Ir5PJb2ispxT0Ew==')

WebUI.click(findTestObject('Page_Test Login  Practice Test Automation/button_Submit'))

WebUI.verifyTextPresent('Congratulations student', false)
